USE [master]
GO
/****** Object:  Database [EMedicine]    Script Date: 16-06-2023 19:56:19 ******/
CREATE DATABASE [EMedicine]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'EMedicine', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\EMedicine.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'EMedicine_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\EMedicine_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
